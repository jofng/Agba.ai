...
The Portal-service is a core component of the Agba Voice AI Platform that handles portal functionality.

## Overview

This service provides essential portal capabilities for the platform.
...
Service-specific API endpoints for portal operations.
...
Contact the development team for portal related issues.
